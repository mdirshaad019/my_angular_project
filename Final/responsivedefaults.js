...
/* harmony import */ var _core_Container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/Container */ "./node_modules/@amcharts/amcharts4/.internal/core/Container.js");
/* harmony import */ var _core_elements_Rectangle__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../core/elements/Rectangle */ "./node_modules/@amcharts/amcharts4/.internal/core/elements/Rectangle.js");
...
var SmallMap = /** @class */ (function (_super) {
    ...
    function SmallMap() {
         ...
         */
        _this._chart = new _core_utils_Disposer__WEBPACK_IMPORTED_MODULE_3__["MutableValueDisposer"]();
        ...
        // Create a container
        _this.seriesContainer = _this.createChild(_core_Container__WEBPACK_IMPORTED_MODULE_0__["Container"]);
        _this.seriesContainer.shouldClone = false;
        // Create an outline rectangle
        var rectangle = _this.createChild(_core_elements_Rectangle__WEBPACK_IMPORTED_MODULE_1__["Rectangle"]);
        rectangle.shouldClone = false;
        rectangle.stroke = interfaceColors.getFor("alternativeBackground");
        rectangle.strokeWidth = 1;
        rectangle.strokeOpacity = 0.5;
        rectangle.fill = Object(_core_utils_Color__WEBPACK_IMPORTED_MODULE_5__["color"])(); //"none";
    ...
    Object.defineProperty(SmallMap.prototype, "series", {
        ...
        get: function () {
            if (!this._series) {
                this._series = new _core_utils_List__WEBPACK_IMPORTED_MODULE_2__["List"]();
    ...
    SmallMap.prototype.moveToPosition = function (event) {
        ...
        var rectPoint = _core_utils_Utils__WEBPACK_IMPORTED_MODULE_7__["svgPointToSprite"](svgPoint, this.rectangle);
    ...
    Object.defineProperty(SmallMap.prototype, "chart", {
        ...
        set: function (chart) {
            if (this.chart != chart) {
                this._chart.set(chart, new _core_utils_Disposer__WEBPACK_IMPORTED_MODULE_3__["MultiDisposer"]([
    ...
    SmallMap.prototype.processConfig = function (config) {
        if (config) {
            // Set up series
            if (_core_utils_Type__WEBPACK_IMPORTED_MODULE_8__["hasValue"](config.series) && _core_utils_Type__WEBPACK_IMPORTED_MODULE_8__["isArray"](config.series)) {
                for (var i = 0, len = config.series.length; i < len; i++) {
                    var series = config.series[i];
                    if (_core_utils_Type__WEBPACK_IMPORTED_MODULE_8__["hasValue"](series) && _core_utils_Type__WEBPACK_IMPORTED_MODULE_8__["isString"](series) && this.map.hasKey(series)) {
 ...
 * @ignore
 */
_core_Registry__WEBPACK_IMPORTED_MODULE_4__["registry"].registeredClasses["SmallMap"] = SmallMap;
...
/* harmony import */ var _core_Container__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../core/Container */ "./node_modules/@amcharts/amcharts4/.internal/core/Container.js");
/* harmony import */ var _core_elements_Button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../core/elements/Button */ "./node_modules/@amcharts/amcharts4/.internal/core/elements/Button.js");
...
/* harmony import */ var _core_utils_Disposer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/utils/Disposer */ "./node_modules/@amcharts/amcharts4/.internal/core/utils/Disposer.js");
/* harmony import */ var _core_utils_Keyboard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/utils/Keyboard */ "./node_modules/@amcharts/amcharts4/.internal/core/utils/Keyboard.js");
/* harmony import */ var _core_interaction_Interaction__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../core/interaction/Interaction */ "./node_modules/@amcharts/amcharts4/.internal/core/interaction/Interaction.js");
...
var ZoomControl = /** @class */ (function (_super) {
    ...
    function ZoomControl() {
        ...
        var plusButton = _this.createChild(_core_elements_Button__WEBPACK_IMPORTED_MODULE_1__["Button"]);
        plusButton.shouldClone = false;
        plusButton.label.text = "+";
        plusButton.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
        plusButton.padding(5, 5, 5, 5);
        _this.plusButton = plusButton;
        var slider = _this.createChild(_core_Container__WEBPACK_IMPORTED_MODULE_0__["Container"]);
        slider.shouldClone = false;
        slider.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
        ...
        _this.slider = slider;
        var thumb = slider.createChild(_core_elements_Button__WEBPACK_IMPORTED_MODULE_1__["Button"]);
        thumb.shouldClone = false;
        thumb.padding(0, 0, 0, 0);
        thumb.draggable = true;
        thumb.events.on("drag", _this.handleThumbDrag, _this);
        _this.thumb = thumb;
        var minusButton = _this.createChild(_core_elements_Button__WEBPACK_IMPORTED_MODULE_1__["Button"]);
    ...
    ZoomControl.prototype.fixLayout = function () {
        if (this.layout == "vertical") {
            ...
            this.minusButton.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.thumb.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.plusButton.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.slider.width = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            ...
            this.minusButton.height = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.minusButton.width = 30;
            this.thumb.height = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.thumb.width = undefined;
            this.plusButton.height = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.plusButton.width = 30;
            this.slider.height = Object(_core_utils_Percent__WEBPACK_IMPORTED_MODULE_6__["percent"])(100);
            this.slider.width = 0;
    ...
    Object.defineProperty(ZoomControl.prototype, "chart", {
        ...
        set: function (chart) {
            ...
            this._chart.set(chart, new _core_utils_Disposer__WEBPACK_IMPORTED_MODULE_3__["MultiDisposer"]([
                ...
                Object(_core_interaction_Interaction__WEBPACK_IMPORTED_MODULE_5__["getInteraction"])().body.events.on("keyup", function (ev) {
                    if (_this.topParent.hasFocused) {
                        if (_core_utils_Keyboard__WEBPACK_IMPORTED_MODULE_4__["keyboard"].isKey(ev.event, "enter")) {
                        ...
                        else if (_core_utils_Keyboard__WEBPACK_IMPORTED_MODULE_4__["keyboard"].isKey(ev.event, "plus")) {
                            chart.zoomIn();
                        }
                        else if (_core_utils_Keyboard__WEBPACK_IMPORTED_MODULE_4__["keyboard"].isKey(ev.event, "minus")) {
                            chart.zoomOut();
                        }
                    }
                }, chart),
    ...
    ZoomControl.prototype.createBackground = function () {
        return new _core_elements_RoundedRectangle__WEBPACK_IMPORTED_MODULE_2__["RoundedRectangle"]();
    };
    return ZoomControl;
}(_core_Container__WEBPACK_IMPORTED_MODULE_0__["Container"]));
 ...
 * @ignore
 */
_core_Registry__WEBPACK_IMPORTED_MODULE_7__["registry"].registeredClasses["ZoomControl"] = ZoomControl;
